...
| Tests | pytest + Hypothesis (334 passing) + Vitest (53 passing) + Playwright (6 smoke, in CI as `continue-on-error`); Vite build as frontend gate |
...
```bash
# Backend tests (334 passing, 1 skipped)
